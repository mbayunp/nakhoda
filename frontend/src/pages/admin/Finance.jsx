...
const Finance = () => {
  ...
  const handleDelete = async (item) => {
    const { isConfirmed } = await Swal.fire({ title: 'Hapus Transaksi?', icon: 'warning', showCancelButton: true, confirmButtonColor: '#ef4444', confirmButtonText: 'Ya, Hapus', cancelButtonText: 'Batal' });
