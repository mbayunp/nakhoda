...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-5%] w-96 h-96 bg-brand/10 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 bg-blue-500/10 rounded-full blur-3xl pointer-events-none"></div>

      {/* Main Container */}
      <div className="w-full max-w-5xl flex flex-col md:flex-row-reverse rounded-[2rem] shadow-2xl overflow-hidden bg-white relative z-10 border border-gray-100">

        {/* Right Side - Branding (Hidden on mobile) */}
        {/* Sengaja ditaruh di sisi sebaliknya (kanan) agar terasa dinamis saat pindah dari halaman Login */}
        <div className="hidden md:flex md:w-5/12 bg-gray-900 p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 font-medium">Pendaftaran Akses Admin</p>
          </div>

          <div className="relative z-10 mt-12">
            <div className="p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <p className="text-gray-300 text-sm leading-relaxed">
                "Pastikan data yang didaftarkan valid. Akses akun baru mungkin memerlukan persetujuan Owner sebelum bisa digunakan sepenuhnya."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-7/12 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-500">Silakan lengkapi form di bawah untuk mendaftarkan akun.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Misal: Jati Gunawan"
              />
            </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              Sudah memiliki akses? <Link to="/login" className="text-brand font-semibold hover:underline transition-all">Masuk di sini</Link>
            </p>
          </form>
        </div>
